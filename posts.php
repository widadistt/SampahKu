...
<body>
    <div class="w3-container">
        ...
        <p>
            ...
            <input type="submit" value="Posts" id="getPosts" class="w3-btn w3-white w3-border w3-border-blue w3-margin" onclick="location.href = 'https://sampahku.herokuapp.com/posts.php'">
    ...
    <script>
        ...
        function contentClicked(e) {
            ...
            // DELETE waste
            if (delClicked) {
                fetch(`https://sampahku-api.herokuapp.com/posts/${id}`, {
                    method: 'DELETE',
                })
                    .then(res => res.json())
